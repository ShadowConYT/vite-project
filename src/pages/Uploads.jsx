...
const ShipmentTracker = () => {
  ...
  const { shipments, shipmentError, shipmentErrors, isDownloadEmailSent } =
  ...
  const handleFileUpload = useCallback(async (event) => {
    ...
    reader.onload = (e) => {
      try {
        ...
        setError(
          "Error parsing the Excel file. Please ensure it is correctly formatted."
        );
        toast.error(
          "Error parsing the Excel file. Please ensure it is correctly formatted."
        );
        ...
        <div className="flex justify-between items-center mb-4">
          <div className="text-left mb-1">
            ...
            <p className="text-gray-600">
              Track multiple shipments across different carriers
            </p>
          </div>
        </div>
        <Materials />
        <div className="border-2 border-black p-3 rounded-xl">
          <div className="bg-white rounded-lg shadow-sm p-6 mb-4">
                ...
                <div key={item.id} className="flex gap-4 items-center">
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      value={item.ref}
                      onChange={(e) =>
                        handleInputChange(item.id, "ref", e.target.value)
                      }
                  ...
                  <div className="w-48">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange(item.id, "plant", e.target.value)
                      }
                      className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
                      disabled={!!uploadedFile}
                    >
                  ...
                  <div className="w-48">
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        handleInputChange(item.id, "liner_name", e.target.value)
                      }
                      className="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
                      disabled={!!uploadedFile}
                    >
            ...
            <div className="p-5 float-right">
              <Button
                className="!bg-blue-600 !text-white !font-normal hover:!bg-blue-700"
          ...
          <div className="w-full flex justify-center">
            <Button
              ...
              className="!w-48 !bg-blue-600 !text-white !p-2 !rounded-xl"
            >
              Check Live Status
            </Button>
